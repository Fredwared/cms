...
CKEDITOR.plugins.add('insertvideo', {
    ...
    init: function (editor) {
        var commandName = 'insertvideo';
        var commandNameButton = 'InsertVideo';
        ...
        addButtonAndItem({
            ...
            label: editor.lang.insertvideo.title,
            icon: this.path + 'images/icon.png',
            group: 'content'
        }, function (editor) {
            bootbox.dialog({
                title: editor.lang.insertvideo.title,
            ...
            $.ajax({
                url: editor.config.insertVideoUrl,
            ...
            return {
                insertvideo: CKEDITOR.TRISTATE_OFF
            };
        });
    }
});