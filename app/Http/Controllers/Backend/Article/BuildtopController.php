...
class BuildtopController extends BackendController
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('backend.article.buildtop.listbuildtop', compact('arrListBuildtop'))->render();
        }

        return view('backend.article.buildtop.index', compact('arrListCategory', 'arrListBuildtop', 'arrLanguage', 'language_id', 'category_id'));
    }
    ...
    public function listArticle(Request $request)
    {
        ...
        return view('backend.article.buildtop.listarticle', compact('arrListArticle', 'pagination', 'item'))->render();
    }
