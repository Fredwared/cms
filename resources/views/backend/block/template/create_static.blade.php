...
<div class="sidebar-content sidebar-sm sidebar-scroll">
    <form id="frmBlockTemplate" name="frmBlockTemplate" role="form" action="{{ route('backend.block.template.store', [$type]) }}" method="post">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="template_content" name="template_content" data-editor="{{ json_encode(['width' => '99%', 'height' => '250px', 'toolbarName' => 'Content', 'language' => auth('backend')->user()->default_language]) }}">{{ old('template_content') }}</textarea>
        </div>
        <div class="form-group">
