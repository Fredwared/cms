...
<div class="box box-primary">
    <!-- form start -->
    <form id="frmCategory" name="frmCategory" role="form" action="{{ route('backend.product.category.update', [$categoryInfo->category_id]) }}" method="post">
        <div class="box-body">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        @if (count($arrLanguage) > 1)
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <select class="form-control" id="language_id" name="language_id" data-linkcategory="{{ route('backend.utils.getcateparent', ['category_type' => $categoryInfo->category_type]) }}" data-linksource="{{ route('backend.utils.getsourcelangmap', ['category_type' => $categoryInfo->category_type]) }}"{!! $categoryInfo->products->count() > 0 ? ' disabled="disabled"' : '' !!}>
        ...
        <div class="box-footer clearfix">
            <div class="pull-left">
                <a role="button" class="btn btn-primary" href="{{ route('backend.product.category.index', ['language_id' => $categoryInfo->language_id]) }}"><i class="fa fa-angle-double-left"></i> {{ trans('common.button.back') }}</a>
            </div>
