...
<div class="box box-primary">
    <!-- form start -->
    <form id="frmPage" name="frmPage" role="form" action="{{ route('backend.configwebsite.page.store') }}" method="post">
        <div class="box-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" id="page_title" name="page_title" value="{{ old('page_title') }}" placeholder="Tên trang" data-code="true" data-for="#page_code" data-link="{{ route('backend.utils.createcode') }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control" id="page_code" name="page_code" value="{{ old('page_code', ($pageSourceInfo ? $pageSourceInfo->page_code : '')) }}" placeholder="Code">
                        </div>
                        ...
                        @if (count($arrLanguage) > 1)
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <select class="form-control" id="page_source" name="page_source" data-id="{{ old('page_source', $page_source) }}"></select>
                            </div>
                        @else
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control" id="page_seo_title" name="page_seo_title" value="{{ old('page_seo_title', ($pageSourceInfo ? $pageSourceInfo->page_seo_title : '')) }}" placeholder="Tiêu đề trang web">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="page_seo_keywords">Từ khóa</label>
                            <input type="text" class="form-control" id="page_seo_keywords" name="page_seo_keywords" value="{{ old('page_seo_keywords', ($pageSourceInfo ? $pageSourceInfo->page_seo_keywords : '')) }}" placeholder="Từ khóa">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="page_seo_description">Mô tả</label>
                            <textarea class="form-control" rows="3" id="page_seo_description" name="page_seo_description" placeholder="Mô tả">{{ old('page_seo_description', ($pageSourceInfo ? $pageSourceInfo->page_seo_description : '')) }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <textarea class="form-control" rows="3" id="page_content" name="page_content" placeholder="Nội dung" data-editor="{{ json_encode(['width' => '99%', 'height' => '425px', 'toolbarName' => 'Content', 'language' => auth('backend')->user()->default_language]) }}">{{ old('page_content', ($pageSourceInfo ? $pageSourceInfo->page_content : '')) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="box-footer clearfix">
            <div class="pull-left">
                <a role="button" class="btn btn-primary" href="{{ route('backend.configwebsite.page.index', ['language_id' => $language]) }}"><i class="fa fa-angle-double-left"></i> {{ trans('common.button.back') }}</a>
            </div>
