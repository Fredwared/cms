...
<div class="box box-primary">
	<!-- form start -->
	<form id="frmMenu" name="frmMenu" role="form" action="{{ route('backend.menu.store') }}" method="post">
		<div class="box-body">
			<div class="row">
    			<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
					...
					<div class="row">
						@if (count(config('cms.backend.languages')) == 1)
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
								<input type="text" class="form-control" id="menu_name_{!! $key !!}" name="menu_name[{!! $key !!}]" value="{{ old('menu_name.' . $key) }}" placeholder="Tên menu">
							</div>
						@else
							@foreach (config('cms.backend.languages') as $key => $lang)
								<div class="col-lg-{{ 12 / count(config('cms.backend.languages')) }} col-md-{{ 12 / count(config('cms.backend.languages')) }} col-sm-12 col-xs-12 form-group has-feedback">
									<input type="text" class="form-control" id="menu_name_{!! $key !!}" name="menu_name[{!! $key !!}]" value="{{ old('menu_name.' . $key) }}" placeholder="{{ $lang['native'] }}">
                    ...
                    <div class="row">
            			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
            				...
            				<input type="text" class="form-control" id="menu_code" name="menu_code" value="{{ old('menu_code') }}" placeholder="Mã menu">
            			</div>
            			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
            				<label for="menu_url">Tên route</label>
            				<input type="text" class="form-control" id="route_name" name="route_name" value="{{ old('route_name') }}" placeholder="Tên route">
            			</div>
            			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
            				<label for="menu_icon">Icon menu</label>
            				<input type="text" class="form-control" id="menu_icon" name="menu_icon" value="{{ old('menu_icon', 'fa-hand-o-right') }}" placeholder="Icon của menu">
            			</div>
            			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
            				...
            				<select class="form-control" id="parent_id" name="parent_id">
            					...
            					@foreach ($arrListMenu as $menu)
            						<option value="{{ $menu->menu_id }}"{!! $menu->menu_id == old('parent_id') ? ' selected="selected"' : '' !!}>
            			...
            			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
            				...
            				<input type="text" class="form-control" id="display_order" name="display_order" value="{{ old('display_order') }}" placeholder="Thứ tự hiển thị">
            			</div>
        			</div>
