<div class="sidebar-content sidebar-sm">
	...
	<form id="frmCountry" name="frmCountry" role="form" action="{{ route('backend.location.country.store') }}" method="post">
		<div class="form-group">
			<label for="country_name" class="required">Tên quốc gia</label>
			<input type="text" class="form-control" id="country_name" name="country_name" value="{{ old('country_name') }}" placeholder="Tên quốc gia">
		</div>
		<div class="form-group">
			<label for="country_code" class="required">Mã quốc gia</label>
			<input type="text" class="form-control" id="country_code" name="country_code" value="{{ old('country_code') }}" placeholder="Mã quốc gia">
		</div>
