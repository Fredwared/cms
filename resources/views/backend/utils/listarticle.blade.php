<div class="sidebar-header">Danh sách bài viết</div>
<div id="panelListArticle" class="sidebar-content sidebar-md">
    <form method="get" action="{{ route('backend.utils.getarticle', ['language_id' => $language_id]) }}" id="frmListArticle" name="frmListArticle">
    ...
    <div class="box-footer clearfix pagination-ajax">
